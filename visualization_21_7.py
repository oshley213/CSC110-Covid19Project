"""Visualization for 2021 July"""

import plotly.graph_objects as go

import pandas as pd

df = pd.read_csv('../../Data/Visualization/covid_21_07.csv')
df.head()
...
dg = pd.read_csv('../../Data/Visualization/crime_21_07.csv')
dg.head()
...
fig.update_layout(
    title_text='2021 July Covid-19 vs. Crimes',
    showlegend=True,
    geo=dict(
