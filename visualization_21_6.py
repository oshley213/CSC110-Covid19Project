"""Visualization for 2021 June"""

import plotly.graph_objects as go

import pandas as pd

df = pd.read_csv('../../Data/Visualization/covid_21_06.csv')
df.head()
...
dg = pd.read_csv('../../Data/Visualization/crime_21_06.csv')
dg.head()
...
fig.update_layout(
    title_text='2021 June Covid-19 vs. Crimes',
    showlegend=True,
    geo=dict(
